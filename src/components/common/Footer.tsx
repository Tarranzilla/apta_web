        ...
        <footer>
            ...
            <div className="footer_category_container">
                <div className="footer_category">
                    ...
                    <div className="footer_category_list footer_category_social_media">
                        <a href="#">
                            Facebook <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                        <a href="#">
                            Youtube <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                        <a href="#">
                            Twitter <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                        <a href="#">
                            Instagram <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                        <a href="#">
                            LinkedIn <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                    </div>
                </div>
                ...
                <div className="footer_category">
                    ...
                    <div className="footer_category_list">
                        <a href="#">
                            Converse pelo Whatsapp <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                        <a href="#">
                            Envie um Email <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                        <a href="#">
                            Ligue para gente <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                    </div>
                </div>
                ...
                <div className="footer_category">
                    ...
                    <div className="footer_category_list">
                        <a href="#">
                            Termos de Uso <span className=" footer_link_icon material-icons">north_east</span>
                        </a>

                        <a href="#">
                            Política de Privacidade <span className=" footer_link_icon material-icons">north_east</span>
                        </a>
                    </div>
                </div>
            </div>
